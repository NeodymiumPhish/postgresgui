...
struct DetailContentView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            // Top row: Tables list | Query results (with resizable divider)
            ResizableSplitView(
                minLeftWidth: 180,
                minRightWidth: 400,
                idealLeftWidth: 200,
    ...
    private func refreshQuery() {
        DebugLog.print("🔄 [DetailContentView] Refresh button clicked")
        Task {
            ...
            do {
                DebugLog.print("📊 [DetailContentView] Executing query...")
                ...
                DebugLog.print("✅ [DetailContentView] Query executed successfully, showing results")
            } catch {
                ...
                DebugLog.print("❌ [DetailContentView] Query execution failed: \(error)")
            }
    ...
    private func deleteSelectedRows() {
        DebugLog.print("🗑️ [DetailContentView] Delete button clicked for \(appState.selectedRowIDs.count) row(s)")
    ...
    private func editSelectedRows() {
        DebugLog.print("✏️ [DetailContentView] Edit button clicked for \(appState.selectedRowIDs.count) row(s)")
    ...
    private func saveEditedRow(originalRow: TableRow, updatedValues: [String: String?]) async throws {
        DebugLog.print("🟡 [DetailContentView.saveEditedRow] Received updatedValues: \(updatedValues)")
